...
Section contents.
  ...
  Proof with simpl; auto.
    ...
    destruct fm.
      destruct o2...  destruct o3... destruct o1... destruct o4...
      apply CRle_trans with (finv m m2)...
    destruct o1... destruct o4... destruct o2... destruct o3...
    apply CRle_trans with (finv m m2)...
  Qed.
  ...
  Proof with auto.
    ...
    split.
      destruct fm; simpl proj1_sig.
        destruct o2... destruct o3...
        simpl.
        rewrite <- (inv_correct' fm finv finv_correct p t).
        apply CRle_trans with (finv m (f p t))...
...
Section contents.
  ...
  Proof with auto.
    ...
    destruct o2; destruct o4; auto; apply <- CRnonNeg_le_zero;
