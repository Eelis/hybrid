...
Section contents.
  ...
  Definition in_orange_alt r p: in_orange p r <-> in_or p r.
    ...
    unfold omle.
    simpl.
    destruct c; destruct c0; destruct fm; tauto.
  Qed.
  ...
  Proof with simpl; auto.
    ...
    destruct fm.
      destruct c2...  destruct c3... destruct c1... destruct c4...
      apply CRle_trans with (finv c1 c3)...
    destruct c1... destruct c4... destruct c2... destruct c3...
    apply CRle_trans with (finv c1 c3)...
  Qed.
  ...
  Proof with auto.
    ...
    split.
      destruct fm; simpl proj1_sig.
        destruct c2... destruct c3...
        simpl.
        rewrite <- (inv_correct' fm finv finv_correct p t).
        apply CRle_trans with (finv c2 (f p t))...
      destruct c1... destruct c4...
      simpl.
      rewrite <- (inv_correct' fm finv finv_correct p t).
      apply CRle_trans with (finv c1 (f p t))...
    destruct fm; simpl proj1_sig.
      destruct c1... destruct c4...
      simpl.
      rewrite <- (inv_correct' fm finv finv_correct p t).
...
Section contents.
  ...
  Proof with auto.
    ...
    destruct c0; destruct c2; auto; apply <- CRnonNeg_le_zero; apply CRle_trans with t...
    apply CRmin_glb...
  Qed.
