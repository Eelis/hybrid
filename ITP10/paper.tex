...
\>[B]{}\ensuremath{\mathbf{Record}}\;\Conid{System}\mathbin{:}\Conid{Type}\mathbin{:=}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\hspace{0.9mm}\{\Conid{Point}\mathbin{:}\Conid{CSetoid}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Conid{Location}\mathbin{:}\Conid{Set}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Conid{Location\char95 eq\char95 dec}\mathbin{:}\Conid{EqDec}\;\Conid{Location}\;\Varid{eq}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{locations}\mathbin{:}\Conid{ExhaustiveList}\;\Conid{Location}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Conid{State}\mathbin{:=}{}\<[15]%
\>[15]{}\Conid{Location}\;\Varid{x}\;\Conid{Point}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{initial}\mathbin{:}\Conid{State}\to \Conid{Prop}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{invariant}\mathbin{:}\Conid{State}\to \Conid{Prop}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{invariant\char95 initial}\mathbin{:}\Varid{initial}\;\Varid{subsetof}\;\Varid{invariant}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{invariant\char95 stable}\mathbin{:}\ensuremath{\forall}\;\Varid{s},\Conid{Stable}\;(\Varid{invariant}\;\Varid{s}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{flow}\mathbin{:}\Conid{Location}\to \Conid{Flow}\;\Conid{Point}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{guard}\mathbin{:}\Conid{State}\to \Conid{Location}\to \Conid{Prop}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{};\Varid{reset}\mathbin{:}\Conid{Location}\to \Conid{Location}\to \Conid{Point}\to \Conid{Point}{}\<[52]%
\>[52]{}\mskip1.5mu\}.{}\<[52E]%
\ColumnHook
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{return\char95 DN}\mathbin{:}\ensuremath{\forall}\;\Conid{A},\Conid{A}\to \Conid{DN}\;\Conid{A}{}\<[E]%
\\
\>[3]{}\Varid{bind}_{\Conid{DN}}\mathbin{:}\ensuremath{\forall}\;\Conid{A}\;\Conid{B},\Conid{DN}\;\Conid{A}\to (\Conid{A}\to \Conid{DN}\;\Conid{B})\to \Conid{DN}\;\Conid{B}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{60E}{@{}l@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\ensuremath{\mathbf{Record}}\;\Conid{Space}\mathbin{:}\Conid{Type}\mathbin{:=}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\hspace{0.9mm}\{\Conid{Region}\mathbin{:}\Conid{Set}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{};\Conid{Region\char95 eq\char95 dec}\mathbin{:}\Conid{EqDec}\;\Conid{Region}\;\Varid{eq}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{};\Varid{regions}\mathbin{:}\Conid{ExhaustiveList}\;\Conid{Region}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{};\Conid{NoDup\char95 regions}\mathbin{:}\Conid{NoDup}\;\Varid{regions}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{};\Varid{in\char95 region}\mathbin{:}\Conid{Container}\;\Conid{Point}\;\Conid{Region}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{};\Varid{regions\char95 cover}\mathbin{:}\ensuremath{\forall}\;(\Varid{l}\mathbin{:}\Conid{Location})\;(\Varid{p}\mathbin{:}\Conid{Point}),{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{invariant}\;(\Varid{l},\Varid{p})\to \Conid{DN}\;\hspace{0.9mm}\{\Varid{r}\mathbin{:}\Conid{Region}\mid \Varid{p}\in \Varid{r}\mskip1.5mu\}{}\<[60]%
\>[60]{}\mskip1.5mu\}.{}\<[60E]%
\ColumnHook
\end{hscode}\resethooks

The \ensuremath{\Conid{Container}\;\Conid{Point}\;\Conid{Region}} type specified for \ensuremath{\Varid{in\char95 region}} reduces to
\ensuremath{\Conid{Point}\to \Conid{Region}\to \Conid{Prop}}. \ensuremath{\Conid{Container}} is a type class that provides
the notation ``\ensuremath{\Varid{x}\in \Varid{y}}'', prettier than ``\ensuremath{\Varid{in\char95 region}\;\Varid{x}\;\Varid{y}}''. \ensuremath{\Varid{regions\char95 cover}} expresses that each concrete point belonging to
...
We define \ensuremath{\Varid{underestimation}\;\Conid{P}} to be either a proof of
\ensuremath{\Conid{P}}, or not. In Coq, either of the following will do:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\ensuremath{\mathbf{Definition}}\;\Varid{underestimation}\;(\Conid{P}\mathbin{:}\Conid{Prop})\mathbin{:}\Conid{Set}\mathbin{:=}\Varid{option}\;\Conid{P}.{}\<[E]%
\\
\>[B]{}\ensuremath{\mathbf{Definition}}\;\Varid{underestimation}\;(\Conid{P}\mathbin{:}\Conid{Prop})\mathbin{:}\Conid{Set}\mathbin{:=}\hspace{0.9mm}\{\Varid{b}\mathbin{:}\Varid{bool}\mid \Varid{b}\mathrel{=}\Varid{true}\to \Conid{P}\mskip1.5mu\}.{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
The latter tends to work better with the \ensuremath{\ensuremath{\mathbf{Program}}} family of commands
\cite{sozeau} which have special support for dependent pairs. Using
\ensuremath{\ensuremath{\mathbf{Program}}}, an underestimation of the second variety may be
...
\ensuremath{\ensuremath{\mathbf{Program}}}. The second form also nicely illustrates why we call this an
underestimation: it may be \ensuremath{\Varid{false}} even when \ensuremath{\Conid{P}} holds. We can now
describe the functionality of our program by saying that it
underestimates hybrid system safety, yielding a term of type
\ensuremath{\Varid{underestimation}\;\Conid{Safe}}, where \ensuremath{\Conid{Safe}} is a proposition expressing
...
\ensuremath{\Varid{false}}/\ensuremath{\Conid{None}}. Hence, the value of our program is not witnessed by
the mere fact that it manages to produce terms of type
\ensuremath{\Varid{underestimation}\;\Conid{Safe}}, but rather by the fact that when run, it
actually manages to returns \ensuremath{\Varid{true}}/\ensuremath{\Conid{Just}\;\Conid{P}} for the hybrid system we
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\ensuremath{\mathbf{Definition}}\;\Varid{overestimation}\;(\Conid{P}\mathbin{:}\Conid{Prop})\mathbin{:}\Conid{Set}\mathbin{:=}\hspace{0.9mm}\{\Varid{b}\mathbin{:}\Varid{bool}\mid \Varid{b}\mathrel{=}\Varid{false}\to \mathord{\sim}\Conid{P}\mskip1.5mu\}.{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{overestimate}_{\leq _{\Conid{CR}}}\;(\epsilon \mathbin{:}\mathbb{Q}^{+})\mathbin{:}\ensuremath{\forall}\;\Varid{x}\;\Varid{y}\mathbin{:}\Conid{CR},\Varid{overestimation}\;(\Varid{x}\leq _{\Conid{CR}}\Varid{y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
As discussed earlier, \ensuremath{\leq _{\Conid{CR}}} is not
decidable. \ensuremath{\Varid{overestimate}_{\leq _{\Conid{CR}}}} merely makes a ``best effort'' to prove
\ensuremath{\mathord{\sim}(\Varid{x}\leq _{\Conid{CR}}\Varid{y})} using \ensuremath{\epsilon }-approximations. A smaller \ensuremath{\epsilon }
will result in fewer spurious \ensuremath{\Varid{true}} results.
...
\label{abs.reach}
Once we have a satisfactory abstract \ensuremath{\Conid{Space}}, our goal is to construct
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\ensuremath{\mathbf{Definition}}\;\Varid{shared\char95 cover}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}`\hspace{0.9mm}\{\Conid{Container}\;\Varid{concrete}.\Conid{State}\;\Conid{C}\mskip1.5mu\}`\hspace{0.9mm}\{\Conid{Container}\;\Varid{abstract}.\Conid{State}\;\Conid{D}\mskip1.5mu\}{}\<[E]%
\\
\>[5]{}\hsindent{2}{}\<[7]%
\>[7]{}(\Varid{cs}\mathbin{:}\Conid{C})\;(\Varid{ss}\mathbin{:}\Conid{D})\mathbin{:}\Conid{Prop}\mathbin{:=}{}\<[E]%
\\
\>[7]{}\hsindent{2}{}\<[9]%
\>[9]{}\ensuremath{\forall}\;\Varid{s}\mathbin{:}\Varid{concrete}.\Conid{State},\Conid{In}\;\Varid{s}\;\Varid{cs}\to \Conid{DN}\;(\ensuremath{\exists }\;\Varid{r}\mathbin{:}\Varid{abstract}.\Conid{State},\Conid{In}\;\Varid{s}\;\Varid{r}\ensuremath{\wedge }\Conid{In}\;\Varid{r}\;\Varid{ss}).{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

The details of the \ensuremath{\Conid{Container}} type class are of no interest to us
right now; one may think of \ensuremath{\Conid{C}} and \ensuremath{\Conid{D}} as the types of lists over
...
contains it.
We state this in
terms of \ensuremath{\Conid{Container}}s so that the definition applies to any types
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{over\char95 cont\char95 trans}\mathbin{:}\ensuremath{\forall}\;\Varid{s}\mathbin{:}\Varid{abstract}.\Conid{State},{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\hspace{0.9mm}\{\Varid{p}\mathbin{:}\Varid{list}\;\Varid{abstract}.\Conid{State}\mid \Conid{NoDup}\;\Varid{p}\ensuremath{\wedge }\Varid{shared\char95 cover}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}(\Varid{concrete}.\Varid{invariant}\mathbin{`\Varid{inter}`}(\Varid{overlap}\;\Varid{s}\mathbin{`\Varid{compose}`}\Varid{utilflip}\;(\Varid{concrete}.\Varid{cont\char95 trans})))\;\Varid{p}\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
So, \ensuremath{\Varid{over\char95 cont\char95 trans}\;\Varid{s}} should produce a list of abstract states \ensuremath{\Varid{p}}
without duplicates,
%(to enhance the graph reachability algorithm that
%we don't detail here, but that will do the actual computation of the
%reachability set), 
such that \ensuremath{\Varid{p}} is a shared cover of the collection
of concrete states \ensuremath{\Varid{c}} that satisfy the invariant and whose set of
origins under \ensuremath{\Varid{concrete}.\Varid{cont\char95 trans}} have an overlap with \ensuremath{\Varid{s}}. In more
mathematical terms: \ensuremath{\Varid{p}} should form a shared cover of $\{ c \in \State
\mid \Inv(c) \wedge s\cap \{c' \mid c' \contrans c\} \neq \emptyset\}$.
We similarly specify \ensuremath{\Varid{over\char95 disc\char95 trans}} as an overestimator for
\ensuremath{\Varid{concrete\char95 disc\char95 trans}} and \ensuremath{\Varid{over\char95 initial}} as an overestimator of
\ensuremath{\Varid{concrete}.\Varid{initial}}. 

We now consider the properties we require for \ensuremath{\Varid{abstract}.\Varid{reachable}}. The following basic specification we had in mind:
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\ensuremath{\mathbf{Definition}}\;\Varid{reachable\char95 respect}\mathbin{:}\Conid{Prop}\mathbin{:=}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\ensuremath{\forall}\;(\Varid{s}\mathbin{:}\Varid{concrete}.\Conid{State}),\Varid{concrete}.\Varid{reachable}\;\Varid{s}\to {}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\ensuremath{\forall}\;(\Varid{s'}\mathbin{:}\Varid{abstract}.\Conid{State}),\Varid{s}\in \Varid{s'}\to \Varid{abstract}.\Varid{reachable}\;\Varid{s'}.{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\ensuremath{\forall}\;(\Varid{s}\mathbin{:}\Varid{concrete}.\Conid{State})\;{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}(\ensuremath{\exists }\;\Varid{s'}\mathbin{:}\Varid{abstract}.\Conid{State},\Varid{s}\in \Varid{s'}\ensuremath{\wedge }\mathord{\sim}\Varid{abstract}.\Varid{reachable}\;\Varid{s'})\to {}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathord{\sim}\Varid{concrete}.\Varid{reachable}\;\Varid{s},{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
want is an \ensuremath{\Varid{abstract}.\Varid{reachable}} satisfying:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}(\ensuremath{\forall}\;\Varid{s'}\mathbin{:}\Varid{abstract}.\Conid{State},\Varid{s}\in \Varid{s'}\to \mathord{\sim}\Varid{abstract}.\Varid{reachable}\;\Varid{s'})\to {}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathord{\sim}\Varid{concrete}.\Varid{reachable}\;\Varid{s}.{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\weg{
This property follows from the following new definition of \ensuremath{\Varid{reachable\char95 respect}} we will use:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{shared\char95 cover}\;\Varid{concrete}.\Varid{reachable}\;\Varid{abstract}.\Varid{reachable}.{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
}
...
transition and initiality overstimators, \ensuremath{\Varid{abstract}.\Varid{reachable}} is
decidable. But first we show how a
decision procedure for \ensuremath{\Varid{abstract}.\Varid{reachable}} lets us underestimate
hybrid system safety, and in particular, lets us obtain a proof of
thermostat safety. So suppose we have \ensuremath{\Varid{reachable\char95 dec}\mathbin{:}\Varid{decider}\;\Varid{abstract}.\Varid{reachable}}
\weg{
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\ensuremath{\mathbf{Variables}}\;{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}(\Varid{unsafe}\mathbin{:}\Varid{concrete}.\Conid{State}\to \Conid{Prop})\;{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}(\Varid{astates}\mathbin{:}\Varid{list}\;\Varid{abstract}.\Conid{State})\;{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}(\Varid{astates\char95 cover\char95 unsafe}\mathbin{:}\ensuremath{\forall}\;\Varid{s},\Varid{unsafe}\;\Varid{s}\to \ensuremath{\forall}\;\Varid{r},\Varid{s}\in \Varid{r}\to \Varid{r}\in \Varid{astates}).{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Then, using \ensuremath{\Varid{reachable\char95 dec}} and \ensuremath{\Varid{unreachable\char95 respect}}, we can easily define
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\ensuremath{\mathbf{Definition}}\;\Varid{over\char95 unsafe\char95 reachable}\mathbin{:}\Varid{overestimation}\;(\Varid{overlap}\;\Varid{unsafe}\;\Varid{concrete}.\Varid{reachable}).{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Taking \ensuremath{\Varid{unsafe}\mathbin{:=}\Varid{thermo\char95 unsafe}} and a suitable abstract cover, we obtain
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\ensuremath{\mathbf{Definition}}\;\Varid{over\char95 thermo\char95 unsafe\char95 reachable}\mathbin{:}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{overestimation}\;(\Varid{overlap}\;\Varid{thermo\char95 unsafe}\;\Varid{concrete}.\Varid{reachable}).{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
}
Recall that \ensuremath{\Conid{ThermoSafe}} was defined as \ensuremath{\Varid{thermo\char95 unsafe}\mathbin{`\Varid{subsetof}`}\Varid{concrete}.\Varid{unreachable}} in section \ref{concrete}. Since we trivially have \ensuremath{\mathord{\sim}\Varid{overlap}\;\Varid{unsafe}\;\Varid{concrete}.\Varid{reachable}\to \Conid{ThermoSafe}}, we also have:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\ensuremath{\mathbf{Definition}}\;\Varid{under\char95 thermo\char95 unsafe\char95 unreachable}\mathbin{:}\Varid{underestimation}\;\Conid{ThermoSafe}.{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\ensuremath{\mathbf{Theorem}}\mathbin{:}\Conid{ThermoSafe}.{}\<[E]%
\\
\>[B]{}\ensuremath{\mathbf{Proof}}.{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{apply}\;(\Varid{underestimation\char95 true}\;\Varid{under\char95 thermo\char95 unsafe\char95 unreachable}).{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{vm\char95 compute}.{}\<[16]%
\>[16]{}\Varid{reflexivity}.{}\<[E]%
\\
\>[B]{}\ensuremath{\mathbf{Qed}}.{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\ensuremath{\Varid{underestimation\char95 true}} is a tiny utility of type \ensuremath{\ensuremath{\forall}\;\Conid{P}\;(\Varid{o}\mathbin{:}\Varid{underestimation}\;\Conid{P}),\Varid{o}\mathrel{=}\Varid{true}\to \Conid{P}}, whose application in the proof reduces the goal to
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{under\char95 thermo\char95 unsafe\char95 unreachable}\mathrel{=}\Varid{true}.{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
 The \ensuremath{\Varid{vm\char95 compute}} tactic invocation then forces evaluation of the left hand side, which will in turn evaluate \ensuremath{\Varid{over\char95 thermo\char95 unsafe\char95 reachable}}, which will evaluate \ensuremath{\Varid{reachable\char95 dec}}, which will evaluate the overestimators of the continuous and discrete transitions. This process, which takes about 35 seconds on a modern desktop machine, eventually reduces \ensuremath{\Varid{under\char95 thermo\char95 unsafe\char95 unreachable}} to \ensuremath{\Varid{true}}, leaving \ensuremath{\Varid{true}\mathrel{=}\Varid{true}}, proved by \ensuremath{\Varid{reflexivity}}.
...
A flow function \ensuremath{\Varid{f}} on \ensuremath{\Conid{CR}} is {\em range invertible\/} if
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\ensuremath{\exists }\;(\Varid{range\char95 inverse}\mathbin{:}\Conid{OpenRange}\to \Conid{OpenRange}\to \Conid{OpenRange}),{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\ensuremath{\forall}\;(\Varid{a}\mathbin{:}\Conid{OpenRange})\;(\Varid{p}\mathbin{:}\Conid{CR}),\Varid{p}\in \Varid{a}\to {}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\ensuremath{\forall}\;(\Varid{b}\mathbin{:}\Conid{OpenRange})\;(\Varid{d}\mathbin{:}\Conid{Duration}),\Varid{f}\;\Varid{p}\;\Varid{d}\in \Varid{b}\to \Varid{d}\in \Varid{range\char95 inverse}\;\Varid{a}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Here, \ensuremath{\Conid{OpenRange}} represents potentially unbounded intervals in $\IR$
...
\ensuremath{\Varid{r\char95 src}} which the flow function map to points in \ensuremath{\Varid{r\char95 dst}}. 
Regions in the abstract space for our thermostat are basically pairs
of regions in the composite spaces, so \ensuremath{\Varid{r\char95 src}} and \ensuremath{\Varid{r\char95 dst}} can be
written as \ensuremath{(\Varid{r\char95 src\char95 temp},\Varid{r\char95 src\char95 clock})} and \ensuremath{(\Varid{r\char95 dst\char95 temp},\Varid{r\char95 dst\char95 clock})}, respectively, where each of these four components are
intervals.

We now simply use an \ensuremath{\Conid{OpenRange}} overlap overestimator of type
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mathbb{Q}^{+}\to \ensuremath{\forall}\;\Varid{a}\;\Varid{b}\mathbin{:}\Conid{OpenRange},\Varid{overestimation}\;(\Varid{overlap}\;\Varid{a}\;\Varid{b}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
(defined in terms of things like \ensuremath{\Varid{overestimate}_{\leq _{\Conid{CR}}}} shown in section \ref{estimation}) to overestimate whether the following three intervals overlap:
\begin{enumerate}
\item \ensuremath{[\mskip1.5mu \mathrm{0},\Varid{inf}\mskip1.5mu]}
\item \ensuremath{\Varid{range\char95 inverse}\;\Varid{temp\char95 flow}\;\Varid{r\char95 src\char95 temp}\;\Varid{r\char95 dst\char95 temp}}
\item \ensuremath{\Varid{range\char95 inverse}\;\Varid{clock\char95 flow}\;\Varid{r\char95 src\char95 clock}\;\Varid{r\char95 dst\char95 clock}}
\end{enumerate}
For a visual explanation, one may consult the left drawing in Figure
\ref{fig:abstraction} and view \ensuremath{\Varid{r\char95 src\char95 clock}} as $[a_1,b_1]$,
\ensuremath{\Varid{r\char95 dst\char95 clock}} as $[c_1,d_1]$ etc.  Overlap of 2 and 3 is equivalent to
existence of a point in \ensuremath{\Varid{r\char95 src}} from which one can flow to a point in
\ensuremath{\Varid{r\char95 dst}}. After all, if these two range inverses overlap, then there is
a duration \ensuremath{\Varid{d}} that takes a certain temperature value in \ensuremath{\Varid{r\char95 src\char95 temp}}
to a value in \ensuremath{\Varid{r\char95 dst\char95 temp}} and also takes a certain clock value in
\ensuremath{\Varid{r\char95 src\char95 clock}} to a value in \ensuremath{\Varid{r\char95 dst\char95 clock}}. If 2 and 3 do \emph{not}
overlap, then either it takes so long for the temperature to flow from
\ensuremath{\Varid{r\char95 src\char95 temp}} to \ensuremath{\Varid{r\char95 dst\char95 temp}} that any clock value in \ensuremath{\Varid{r\char95 src\char95 clock}}
would ``overshoot'' \ensuremath{\Varid{r\char95 dst\char95 clock}}, or vice versa. Finally, if 1 does
...
\ensuremath{\Varid{r\char95 src}} to points in \ensuremath{\Varid{r\char95 dst}}, and so our \ensuremath{\Varid{abstract}.\Varid{cont\char95 trans}}
